...
//   const items = products.filter(item=>(item._id==orders[0].productId))
//   console.log(items);
    useEffect(() => {
        setItems(orders.filter(order=>(order.email==user.email)))
    }, [orders,user.email]);
      ...
      <div className="bg-white p-8 rounded-md w-full">
        <div className=" flex items-center justify-between pb-6">
          <div>
            ...
            <span className="text-xs">Please Proceed order or delete it.</span>
          </div>
                    ...
                    <>
                      <tr>
                        <td
                          ...
                          className="cursor-pointer px-5 py-5 border-b border-gray-200 bg-white text-sm"
                        >
                        ...
                        <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                          <p className="text-gray-900 whitespace-no-wrap">
                            ${parseFloat(order?.product?.price)*parseFloat(order?.orderQuantity)}
                          </p>
                        </td>
                        <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                          <button
